...
class CostumerInvoice(models.Model):
    DELIVERED = 1
    NOT_DELIVERED = 0
...
class CostumerInvoiceItem(models.Model):
    invoice = models.ForeignKey(CostumerInvoice, on_delete=models.PROTECT)
...
class CostumerReceipt(models.Model):
...
class CostumerReceiptInvoice(models.Model):
    invoice = models.ForeignKey(CostumerInvoice, on_delete=models.PROTECT)
    receipt = models.ForeignKey(CostumerReceipt, on_delete=models.PROTECT)
    ...
    class Meta:
        verbose_name = _('Costumer Receipt Invoice')
        verbose_name_plural = _('Costumer Receipt Invoices')
